...
We performed log transformations on the skewed variables, but the histograms of the transformations don't suggest the transformations really improved the situation. Below, we'll compare two full models - one with original predictors and the other with log transformed predictors. Based on the histograms, our hunch is that the transformed predictors won't improve the model.
