...
mod_log_int_fixed = lm(quality ~ (fixed.acidity + log(volatile.acidity) + citric.acid + residual.sugar + chlorides + log(free.sulfur.dioxide) + total.sulfur.dioxide + density + (pH) + (sulphates) + (alcohol) + type)^2, 
                       data = wine_data, 
