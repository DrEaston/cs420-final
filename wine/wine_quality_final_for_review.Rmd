...
This initial model had an Adjusted R-squared value of 0.3031, and we sought to improve on that. 
...
We now have 3 potential interaction models. The full interactive model has 120 predictors, and our backwards AIC and BIC models have 68 and 41, respectively. 
...
We were pleased with the RMSE of our final model. The values were similar for test and train, indicating we were not overfitting. Overall our RMSE was 0.69 on test data, indicating that on average, our predicted quality score was well within 1 point of the actual score. 
